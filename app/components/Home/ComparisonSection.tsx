                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-xl border-2 border-gray-100 overflow-hidden">
                            {/* Header */}
                            <div className="grid grid-cols-3 gap-6 p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b-2 border-gray-200">
                                <div className="text-center">
                                    <p className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Fonctionnalité</p>
                                </div>
                                <div className="text-center">
                                    <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full font-bold text-sm shadow-lg">
                                        ⚡ Vocalcom AI
                                    </div>
                                </div>
                                <div className="text-center">
                            ...
                            {/* CTA */}
                            <div className="p-8 bg-gradient-to-r from-blue-50 to-purple-50 text-center border-t-2 border-gray-200">
                                <p className="text-gray-700 font-semibold mb-4">Prêt à passer à la vitesse supérieure?</p>
                                <a href="#demo" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full hover:shadow-xl transition-all transform hover:-translate-y-1">
                                    Voir la Différence
                                </a>
                            </div>
                        </div>
